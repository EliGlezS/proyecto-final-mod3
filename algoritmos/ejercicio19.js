...
function changesYearsToCenturies(year) {
    ...
    //Verificar que el año que se introduce sea un número de lo contrario se muestra un console.log("No es un número. Introduce uno válido."); .
    ...
    en cambio cuando el resto no da 0, lo que se hace es que se redondea hacia abajo el resultado de año/100
    ...
    console.log(`El siglo al que pertenece el año ${year} es: ${centuries}`);
}
